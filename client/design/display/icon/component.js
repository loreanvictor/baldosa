...
const BASE = `${window.location.origin + window.location.pathname}/client/assets/icons/`
...
define("i-con", ({ src, dark, thick, fill, notifications }) => {
  ...
  onAttribute("notifications", (n) => {
    notifications = n
    shownotif()
  })

  return html`
    <link rel="stylesheet" href="./client/design/display/icon/styles.css" />
    <div ref=${holder}></div>
