      ...
      <div class="list">
        <keyed-list
          ...
          each=${(bookmark) => {
            ...
            const sub = bookmark.meta?.subtitle ?? bookmark.meta?.description ?? ''
        ...
        <small style="font-weight: 100; opacity: .5; display: block">
          Your bookmarks appear here. You can bookmark content you want to revisit later using the bookmark
          <i-con src="bookmark" dark style="width: 2.5ch; vertical-align: middle"></i-con> button. Note that your
          bookmarks aren't synced by your account and are stored locally.
        </small>
      </div>
